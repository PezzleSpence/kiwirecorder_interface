...
class MainApplication(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.userID = tk.Label(self.parent, text="Username")
        self.userID.place(x=0, y=125)
        ...
        self.userIDEntry.place(x=75, y=125)
        self.passEntry = tk.Entry(self.parent, show="*", width=20)
        self.passEntry.place(x=125,y=150)
        ...
        self.recordB.place(x=25, y=200)
        self.stopB.place(x=225, y=200)
    ...
    # stops recording multiprocess and kill it
